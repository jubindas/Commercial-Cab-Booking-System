...
import { createdVendorsData } from "@/table-datas/created-vendor-data"

import { createdVendorsColumns } from "@/table-columns/created-vendors-table-column"




export default function CreatedVendors() {
   return (
        <div className="min-h-screen p-6 bg-zinc-100">
         ...
         <div className="rounded-xl border border-zinc-200 bg-white shadow-md overflow-hidden">
           <DataTable data={createdVendorsData} columns={ createdVendorsColumns } enablePagination />
         </div>
       </div>
     )
   }
